...
class GamesTest(unittest.TestCase):
    ...
    def test_return_one_game(self):
        ...
        res = self.client().post('api/v1/games/',
                                 headers={'Content-Type': 'application/json',
                                          'api-token': api_token},
                                 data=json.dumps(self.game))
        res = self.client().get('api/v1/games/1',
                                headers={'Content-Type': 'application/json',
                                         'api-token': api_token})
        game = self.game
    ...
    def test_non_existing_game(self):
        ...
        res = self.client().post('api/v1/games/',
                                 headers={'Content-Type': 'application/json',
                                          'api-token': api_token},
                                 data=json.dumps(self.game))
        res = self.client().get('api/v1/games/2',
                                headers={'Content-Type': 'application/json',
                                         'api-token': api_token})
    ...
    def test_return_all_games(self):
        ...
        res = self.client().post('api/v1/games/',
                                 headers={'Content-Type': 'application/json',
                                          'api-token': api_token},
                                 data=json.dumps(self.game_2))
        json_data = json.loads(res.data)
        res = self.client().get('api/v1/games/',
                                headers={'Content-Type': 'application/json',
                                         'api-token': api_token})
        json_data = json.loads(res.data)
    ...
    def test_error_when_edit_game_does_not_exist(self):
        ...
        res = self.client().get('api/v1/games/',
                                headers={'Content-Type': 'application/json',
                                         'api-token': api_token})
        json_data = json.loads(res.data)
        res = self.client().patch('api/v1/games/5/edit',
                                  headers={'Content-Type': 'application/json',
                                           'api-token': api_token},
                                  data=json.dumps(updated_game))
        json_data = json.loads(res.data)
